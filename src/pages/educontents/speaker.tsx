...
import speakerKitImg1 from "../../images/detailContents/slide/edu_detail_speaker/speakerImage.png";
import speakerKitImg2 from "../../images/detailContents/slide/edu_detail_speaker/speakerPartImage.png";
import speakerClass1 from "../../images/detailContents/slide/edu_detail_speaker/speakerClassImage1.png";
import speakerClass2 from "../../images/detailContents/slide/edu_detail_speaker/speakerClassImage2.png";
import speakerClass3 from "../../images/detailContents/slide/edu_detail_speaker/speakerClassImage3.png";
import speakerClass4 from "../../images/detailContents/slide/edu_detail_speaker/speakerClassImage4.png";
import speakerClass5 from "../../images/detailContents/slide/edu_detail_speaker/speakerClassImage5.png";
  ...
  return (
    <>
      <Banner
        ...
        route1Opacity={0.7}
        routeDot2="•"
        routeName2="DIY 블루투스 스피커"
        route2="/speaker"
        route2Opacity={1}
        title="DIY 블루투스 스피커"
        subtitle="DIY Bluetooth speaker"
        content="사물인터넷, 블루투스 통신을 이해하고, DIY 블루투스 스피커 제작하기"
        contentClass="Subtitle-smallFont"
        contentsImg={speakerImg}
      />
      ...
      <KitPicture
        title="키트 사진"
        titleMarginTop={12.222}
        imgSrc1={speakerKitImg1}
        imgSrc2={speakerKitImg2}
      ...
      <ContentsSlide
        title="교육 사진"
        titleMarginTop={12.222}
        imgSrc1={speakerClass1}
        imgSrc2={speakerClass2}
        imgSrc3={speakerClass3}
        imgSrc4={speakerClass4}
        imgSrc5={speakerClass5}
      />
